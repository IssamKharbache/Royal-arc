...
<div className="flex items-center justify-center flex-col   ">
          ...
          <div className="grid lg:grid-cols-2 xl:grid-cols-3 gap-6 px-6 md:w-4/5 2xl:w-3/4 cursor-pointer pb-20  items-start ">
