...
export default function ContactForm() {
  ...
  return (
    <div className=" w-full   md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden mt-24 ">
      <div className="flex flex-col items-start lg:flex-row justify-center md:py-20 px-6">
        <div className="">
...
<FormField
                  ...
                  <FormItem className="items-center justify-center w-full">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="51-200">Video editing</SelectItem>
                        <SelectItem value="501-1000">Other</SelectItem>
                      </SelectContent>
                    </Select>
                  </FormItem>
                )}
              ...
              <div className="flex gap-4 items-center">
                ...
                <div className="text-sm font-light  md:w-3/4 mb-1 bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">
                  I agree to Royac&apos;s sending marketing communications
                  related to Royac
                </div>
              </div>
            ...
            <>
              <div
                className="
        text-xl md:text-2xl flex items-center justify-center flex-col px-8"
              >
